...
#import "HishabiAIParameterAddresses.h"
...
public:
    ...
    // Add a case for each parameter in HishabiAIParameterAddresses.h
    void setParameter(AUParameterAddress address, AUValue value) {
        switch (address) {
            case HishabiAIParameterAddress::midiNoteNumber:
                mNextNoteToSend = (uint8_t)value;
                break;
            case HishabiAIParameterAddress::sendNote:
    ...
    void handleMIDIEventList(AUEventSampleTime now, AUMIDIEventList const* midiEvent) {
        /*
         ...
         auto thisObject = static_cast<HishabiAIDSPKernel *>(context);
